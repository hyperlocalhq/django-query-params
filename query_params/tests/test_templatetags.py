...
from query_params.templatetags.query_params_tags import (
...
class QueryParamsTemplateTagTests(TestCase):
    ...
    def test_construct_query_string(self):
        ...
        query_params = [['a', '1'], ['a', 2], ['b', 3], ['c', 'OK'], ['d', 'Hello, World!']]
        path = construct_query_string(context={'request': request}, query_params=query_params)

        self.assertEquals(path, '/en/test/?a=1&amp;a=2&amp;b=3&amp;c=OK&amp;d=Hello%2C+World%21')
